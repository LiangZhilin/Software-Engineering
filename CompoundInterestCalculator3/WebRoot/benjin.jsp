		...
		<div style="width: 600px;margin: auto;margin-top: 10px">
			<div class="panel panel-success">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="#">本金计算<span
								...
								<li><a href="test.action">投资管理</a></li>
							</ul>
						</div>
					</div>
				</nav>
				<div class="panel-body" style="margin:50px;text-align: center">
					<div>
						<form action="<%=path%>/calculateBenjin.action" method="post">
							
							<div class="input-group input-group-lg">
								<span class="input-group-addon" id="sizing-addon1">利率</span> <input
									type="text" name="interest_rate" class="form-control"  value="${request.interest_rate}" 
									placeholder="请输入您的利率" aria-describedby="sizing-addon1">
							</div>
							<div class="input-group input-group-lg">
								<span class="input-group-addon" id="sizing-addon1">期数</span> <input
									type="text" name="nper" class="form-control"
									 value="${request.nper}" 
									placeholder="请输入您要存的期数" aria-describedby="sizing-addon1">
							</div>
							
							<div class="input-group input-group-lg">
								<span class="input-group-addon" id="sizing-addon1">终额</span> <input
									type="text" name="result" class="form-control" value="${request.result}"
									placeholder="请输入你想获得的满期额" aria-describedby="sizing-addon1">
							</div>
							
							<div class="input-group input-group-lg">
								<span class="input-group-addon" id="sizing-addon1">本金</span> <input
									type="text" name="deposit" class="form-control" value="${request.deposit}"
									placeholder="最终计算结果" aria-describedby="sizing-addon1">
							</div>
